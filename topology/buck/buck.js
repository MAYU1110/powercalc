            ...
            newImageElement.onerror = function() {
                ...
                container.innerHTML = `
                    <svg width="600" height="320" viewBox="0 0 600 320" style="max-width: 100%;">
                        ...
                        <circle cx="295" cy="80" r="25" fill="none" stroke="#10b981" stroke-width="2"/>
                        <line x1="295" y1="55" x2="295" y2="105" stroke="#10b981" stroke-width="2"/>
                        <text x="295" y="110" text-anchor="middle" fill="#10b981" font-size="12" font-family="var(--font-mono)">D</text>
                        <line x1="295" y1="55" x2="295" y2="20" stroke="#60a5fa" stroke-width="2"/>
                        <line x1="295" y1="20" x2="50" y2="20" stroke="#60a5fa" stroke-width="2"/>
                        ...
                        <line x1="310" y1="170" x2="400" y2="170" stroke="#60a5fa" stroke-width="2" marker-end="url(#arrowhead)"/>
                        <rect x="400" y="150" width="60" height="40" rx="2" fill="none" stroke="#3b82f6" stroke-width="2"/>
                        <line x1="400" y1="170" x2="460" y2="170" stroke="#3b82f6" stroke-width="2"/>
                        <line x1="430" y1="150" x2="430" y2="190" stroke="#3b82f6" stroke-width="2"/>
                        <text x="430" y="210" text-anchor="middle" fill="#3b82f6" font-size="12" font-family="var(--font-mono)">Cout</text>
                        <line x1="460" y1="170" x2="520" y2="170" stroke="#60a5fa" stroke-width="2" marker-end="url(#arrowhead)"/>
                        <rect x="520" y="150" width="60" height="40" rx="2" fill="none" stroke="#60a5fa" stroke-width="2"/>
                        <text x="550" y="175" text-anchor="middle" fill="#60a5fa" font-size="14" font-family="var(--font-mono)">Vout</text>
                        <line x1="520" y1="190" x2="520" y2="250" stroke="#60a5fa" stroke-width="2"/>
                        <line x1="520" y1="250" x2="50" y2="250" stroke="#60a5fa" stroke-width="2"/>
                        <line x1="50" y1="250" x2="50" y2="100" stroke="#60a5fa" stroke-width="2" marker-start="url(#arrowhead-left)"/>
                        <text x="550" y="290" text-anchor="middle" fill="#64748b" font-size="11" font-family="var(--font-sans)">GND</text>
                        <line x1="10" y1="280" x2="590" y2="280" stroke="#475569" stroke-width="1" stroke-dasharray="5,5"/>
                    </svg>
                `;
            };
        }
        ...
        if (resultsSection) {
            resultsSection.innerHTML = `
                <div class="glass-card" style="padding: var(--spacing-xl); margin-bottom: var(--spacing-lg);">
                    <h3 style="font-size: 1.25rem; font-weight: 600; margin-bottom: var(--spacing-lg); color: var(--accent-success);">✓ Buck降压电路设计计算结果</h3>
                    ...
                    <div class="result-card" style="margin-bottom: var(--spacing-lg);">
                        ...
                        <div class="result-item">
                            ...
                            <span class="result-value">${this.renderMathValue((c * 1000000).toFixed(4), 'μF')}</span>
                        </div>
                    </div>
                    ...
                    <div class="result-card" style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%);">
                        ...
                        <div class="result-item">
                            <span class="result-label">${this.renderMathKey('最小负载电流', 'I_{omin}')}</span>
                            <span class="result-value">${this.renderMathValue(iomin.toFixed(4), 'A')}</span>
                        </div>
                        <div class="result-item">
