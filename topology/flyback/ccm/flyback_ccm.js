const FlybackCCM = {
    ...
    async calculate() {
        ...
        const ap = Number(((p_omax * (Math.sqrt(1 - d_max) + Math.sqrt(d_max)) * f_lambda) / (bm * j * k * fs * eta * 1000) * Math.pow(10, 6)).toFixed(5));
            ...
            resultsSection.innerHTML = `
                <div class="glass-card" style="padding: var(--spacing-xl); margin-bottom: var(--spacing-lg);">
                    ...
                    <div class="result-card" style="margin-bottom: var(--spacing-lg);">
                        ...
                        <div class="result-item">
                            <span class="result-label">${this.renderMathKey('纹波系数函数', 'F(\\lambda_t)')}</span>
                            <span class="result-value">${this.renderMathValue(f_lambda.toFixed(5), '')}</span>
                        </div>
                    </div>
                    ...
                    <div class="result-card" style="margin-bottom: var(--spacing-lg);">
                        ...
                        <div class="result-item">
                            ...
                            <span class="result-value">${this.renderMathValue((lm * 1000).toFixed(5), 'mH')}</span>
                        </div>
                    </div>
                    ...
                    <div class="result-card" style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%);">
                        ...
                        <div class="result-item">
                            ...
                            <span class="result-value">${this.renderMathValue('220 μF/25 V 低ESR', '')}</span>
                        </div>
                        <div class="result-item">
                        ...
                        <div class="result-item">
                            ...
                            <span class="result-value">${this.renderMathValue('600 V 以上', '')}</span>
                        </div>
                        <div class="result-item">
                            <span class="result-label">${this.renderMathKey('二极管', 'V_d')}</span>
                            <span class="result-value">${this.renderMathValue('100 V 以上', '')}</span>
                        </div>
                    </div>
                </div>
            `;
